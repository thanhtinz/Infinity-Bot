...
from src.models.models import (
    ...
    LoggingConfig, TicketConfig, TicketPanel, TicketPanelGroup,
    TicketForm, TicketTeam, TicketClaimConfig, TicketFeedbackConfig,
    LevelingConfig, LevelReward, LevelMultiplier,
    ModerationConfig, FeatureToggle,
    TempVoiceConfig, Product, Coupon,
...
BOT_CONFIG_TABLES = [
    ...
    ("ticket_panel_groups", TicketPanelGroup),
    ("ticket_forms", TicketForm),
    ("ticket_teams", TicketTeam),
    ("ticket_claim_config", TicketClaimConfig),
    ("ticket_feedback_config", TicketFeedbackConfig),
    ...
    ("temp_voice_config", TempVoiceConfig),
    ("products", Product),
    ("coupons", Coupon),
]
