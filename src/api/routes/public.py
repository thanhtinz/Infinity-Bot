...
async def public_commands():
    ...
    command_descriptions = {
        ...
        "delwarn": "Delete a warning by ID.",
        "warnings": "View warning history.",
        "kick": "Kick a member.",
        "ban": "Ban a member.",
        "unban": "Unban a user by ID.",
        "mute": "Mute (timeout) a member.",
        "softban": "Softban a member (ban + unban to delete messages).",
        "deafen": "Deafen a member in voice.",
        "undeafen": "Undeafen a member in voice.",
        "clean": "Clean up bot responses.",
        "members": "List members in a role (max 90).",
        "rolepersist": "Toggle a persistent role (survives leave/rejoin).",
        "temprole": "Assign a temporary role.",
        ...
        "modlogs": "View mod log history for a user.",
        "moderations": "View active timed moderations.",
        "case": "Show a single mod log case.",
        "reason": "Update the reason for a mod case.",
        "duration": "Change duration of a mute/ban.",
        "modstats": "Get moderation statistics for a mod.",
        "lockdown": "Lock/unlock channels defined in settings.",
        "star": "View starboard stats for a message.",
        "ignored": "List ignored users, roles, and channels.",
        "diagnose": "Diagnose bot permissions and module status.",
        "space": "Get ISS location & astronaut info.",
        "dadjoke": "Get a random Dad joke.",
        "cat": "Find a cute cat picture.",
        "dog": "Find a cute dog picture.",
        "pug": "Find a cute pug picture.",
        "norris": "Get a random Chuck Norris fact.",
        "pokemon": "Get info on a Pokémon.",
        "itunes": "Search for a song on iTunes.",
