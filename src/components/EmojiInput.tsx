    ...
    return (
      ...
      >
        <input
          ...
          onChange={onChange}
          className={cn(
            "flex h-9 w-full rounded-md bg-transparent px-3 py-1 text-base shadow-sm transition-colors placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm border-0 focus-visible:ring-0 focus-visible:ring-offset-0 flex-1",
            className
          )}
          {...props}
        />
...
export const EmojiTextarea = React.forwardRef<HTMLTextAreaElement, EmojiTextareaProps>(
  ({ className, wrapperClassName, value = "", onChange, rows = 3, ...props }, ref) => {
    ...
    return (
      <div
        className={cn(
          "flex items-start rounded-md border border-input bg-background focus-within:ring-1 focus-within:ring-ring",
          wrapperClassName
        )}
      >
        <textarea
          ...
          rows={rows}
          className={cn(
            "flex min-h-[60px] w-full rounded-md bg-transparent px-3 py-2 text-base shadow-sm placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm border-0 focus-visible:ring-0 focus-visible:ring-offset-0 flex-1 resize-y",
            className
          )}
          {...props}
        />
