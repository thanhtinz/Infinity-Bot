        ...
        return (
          <div key={idx} className="rounded-lg border overflow-hidden bg-card" style={{ borderLeftWidth: 4, borderLeftColor: borderColor }}>
            ...
            <div className="flex items-center gap-1 px-3 py-2 bg-muted/30">
              ...
              <Button size="icon" variant="ghost" className="h-7 w-7" title="Move up" disabled={idx === 0} onClick={() => onMoveEmbed(idx, "up")}><ArrowUp className="h-3.5 w-3.5" /></Button>
              <Button size="icon" variant="ghost" className="h-7 w-7" title="Move down" disabled={idx === embeds.length - 1} onClick={() => onMoveEmbed(idx, "down")}><ArrowDown className="h-3.5 w-3.5" /></Button>
              <Button size="icon" variant="ghost" className="h-7 w-7" title="Duplicate" onClick={() => onDuplicateEmbed(idx)}><Copy className="h-3.5 w-3.5" /></Button>
              ...
              <div className="px-4 pb-4 pt-3 space-y-4">
                  ...
                  {openState.author && (
                    <div className="px-3 pb-3 space-y-2">
                      <div className="space-y-1">
                        <Label className="text-xs text-muted-foreground">Author name <span className="text-[10px]">{emb.author.length}/256</span></Label>
                        <div className="flex items-center rounded-md border border-input bg-background focus-within:ring-1 focus-within:ring-ring">
                          <Input className="border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-sm" placeholder="Author name" maxLength={256}
                ...
                <div className="space-y-3">
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center rounded-md border border-input bg-background focus-within:ring-1 focus-within:ring-ring">
                      <Input className="border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-sm" placeholder="Title embed" maxLength={256}
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-start rounded-md border border-input bg-background focus-within:ring-1 focus-within:ring-ring">
                      <Textarea className="border-0 focus-visible:ring-0 focus-visible:ring-offset-0 flex-1 text-sm resize-y" placeholder="Description embed..." rows={4} maxLength={4096}
                ...
                <div className="rounded-md border">
                  ...
                  {openState.images && (
                    <div className="px-3 pb-3 space-y-2">
                      ...
                      <div className="space-y-1">
                        <Label className="text-xs text-muted-foreground">Image URL (large)</Label>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center rounded-md border border-input bg-background focus-within:ring-1 focus-within:ring-ring">
                    <Input className="border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-sm" placeholder="Footer content" maxLength={2048}
                      ...
                      {emb.fields.map((field, fi) => (
                        <div key={fi} className="rounded-md border bg-muted/30 p-3 space-y-2">
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <div className="flex items-center rounded-md border border-input bg-background focus-within:ring-1 focus-within:ring-ring">
                              <Input placeholder="Name field" value={field.name} onChange={(e) => onUpdateField(idx, fi, "name", e.target.value)}
                            ...
                            <div className="flex items-center rounded-md border border-input bg-background focus-within:ring-1 focus-within:ring-ring">
                              <Input placeholder="Value" value={field.value} onChange={(e) => onUpdateField(idx, fi, "value", e.target.value)}
                                className="text-sm border-0 focus-visible:ring-0 focus-visible:ring-offset-0" />
