...
const PERM_LABELS: { key: keyof StaffPerm; label: string; desc: string }[] = [
  ...
  { key: "can_forms", label: "Forms", desc: "Form templates, submissions, reviews" },
  { key: "can_reminders", label: "Reminders", desc: "View and manage reminders" },
];
