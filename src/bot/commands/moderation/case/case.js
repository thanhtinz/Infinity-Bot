  ...
  async execute(interaction) {
    ...
    if (!subcommand) {
      return interaction.reply({
        content: await tg(interaction.guildId, 'case.dispatcher.subcommandNotFound', { name: subcommandName }),
        ephemeral: true
      });
    }
    ...
    try {
      ...
      const errorMessage = {
        content: await tg(interaction.guildId, 'case.dispatcher.executionError'),
        ephemeral: true
      };
