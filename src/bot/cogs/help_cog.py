...
HELP_CATEGORIES: list[dict] = [
    ...
    },
    {
        ...
        "name": "Temp Voice",
        "commands": [
            {"name": "room rename",   "emoji": "✏️", "desc": "Rename voice room",               "usage": "`/room rename <name>`"},
            {"name": "room limit",    "emoji": "👥", "desc": "Set room member limit",      "usage": "`/room limit <number>`"},
            {"name": "room lock",     "emoji": "🔒", "desc": "Lock voice room",                   "usage": "`/room lock`"},
            {"name": "room unlock",   "emoji": "🔓", "desc": "Unlock voice room",                "usage": "`/room unlock`"},
            {"name": "room hide",     "emoji": "🫥", "desc": "Hide voice room",                     "usage": "`/room hide`"},
            {"name": "room unhide",   "emoji": "👁️", "desc": "Show voice room",                   "usage": "`/room unhide`"},
            {"name": "room private",  "emoji": "🔐", "desc": "Only allowed members can join",   "usage": "`/room private`"},
            {"name": "room public",   "emoji": "🌐", "desc": "Open room for everyone",             "usage": "`/room public`"},
            {"name": "room permit",   "emoji": "✅", "desc": "Allow user into room",             "usage": "`/room permit <@user>`"},
            {"name": "room reject",   "emoji": "🚫", "desc": "Block user from room",                "usage": "`/room reject <@user>`"},
            {"name": "room boot",     "emoji": "👢", "desc": "Kick user from room",            "usage": "`/room boot <@user>`"},
            {"name": "room mute",     "emoji": "🔇", "desc": "Mute user in room",              "usage": "`/room mute <@user>`"},
            {"name": "room transfer", "emoji": "↔️", "desc": "Transfer room ownership",             "usage": "`/room transfer <@user>`"},
            {"name": "room claim",    "emoji": "👑", "desc": "Claim room if owner left",    "usage": "`/room claim`"},
            {"name": "room bitrate",  "emoji": "🔊", "desc": "Change room bitrate",             "usage": "`/room bitrate <kbps>`"},
            {"name": "room panel",    "emoji": "🎛️", "desc": "Resend room control panel",     "usage": "`/room panel`"},
        ],
    },
    {
        "key": "utility",
