...
HELP_CATEGORIES = [
    ...
    },
    {
        ...
        "commands": [
            ...
            _help_cmd("ticket transfer", "Transfer a ticket to another staff member.", "`/ticket transfer <@user>`"),
            _help_cmd("ticket delete", "Delete a ticket record.", "`/ticket delete`", True),
            _help_cmd("ticket blacklist", "Block a member from creating tickets.", "`/ticket blacklist <@user>`", True),
            _help_cmd("ticket whitelist", "Allow a previously blocked member to create tickets.", "`/ticket whitelist <@user>`", True),
            _help_cmd("panel send", "Send a ticket panel to a channel.", "`/panel send`", True),
    ...
    },
    {
        ...
        "commands": [
            ...
            _help_cmd("sticky create", "Create a text sticky message.", "`/sticky create`", True),
            _help_cmd("sticky embed", "Create an embed sticky message.", "`/sticky embed`", True),
            _help_cmd("sticky edit", "Edit a sticky message.", "`/sticky edit`", True),
            _help_cmd("sticky remove", "Remove a sticky message.", "`/sticky remove`", True),
            _help_cmd("sticky enable", "Enable a sticky message.", "`/sticky enable`", True),
            _help_cmd("sticky disable", "Disable a sticky message.", "`/sticky disable`", True),
            _help_cmd("sticky list", "List sticky messages.", "`/sticky list`", True),
            _help_cmd("sticky view", "View sticky message details.", "`/sticky view`", True),
            _help_cmd("sticky clear", "Clear sticky message data.", "`/sticky clear`", True),
            _help_cmd("sticky interval", "Set sticky resend interval.", "`/sticky interval`", True),
            _help_cmd("sticky messages", "Set sticky message count behavior.", "`/sticky messages`", True),
            _help_cmd("sticky color", "Set sticky embed color.", "`/sticky color`", True),
            _help_cmd("sticky image", "Set sticky embed image.", "`/sticky image`", True),
            _help_cmd("sticky thumbnail", "Set sticky embed thumbnail.", "`/sticky thumbnail`", True),
            _help_cmd("sticky footer", "Set sticky embed footer.", "`/sticky footer`", True),
            _help_cmd("sticky pin", "Pin a sticky message.", "`/sticky pin`", True),
            _help_cmd("sticky unpin", "Unpin a sticky message.", "`/sticky unpin`", True),
            _help_cmd("sticky sync", "Resend all sticky messages.", "`/sticky sync`", True),
            _help_cmd("sticky expire", "Set sticky auto-expiration.", "`/sticky expire`", True),
            _help_cmd("sticky move", "Move a sticky message to another channel.", "`/sticky move`", True),
            _help_cmd("sticky copy", "Copy a sticky message to another channel.", "`/sticky copy`", True),
            _help_cmd("sticky stats", "View sticky message stats.", "`/sticky stats`", True),
            _help_cmd("sticky channel", "Create a sticky message for a target channel.", "`/sticky channel`", True),
        ],
    },
    {
        "key": "moderator",
        ...
        "commands": [
            ...
            _help_cmd("softban", "Softban a member (ban + unban to delete messages).", "`/softban <@user> [reason]`", True),
            _help_cmd("deafen", "Deafen a member in voice.", "`/deafen <@user> [reason]`", True),
            _help_cmd("undeafen", "Undeafen a member in voice.", "`/undeafen <@user>`", True),
            _help_cmd("clean", "Clean up bot responses.", "`/clean [amount]`", True),
            _help_cmd("members", "List members in a role (max 90).", "`/members <@role>`", True),
            _help_cmd("rolepersist", "Toggle a persistent role (survives leave/rejoin).", "`/rolepersist <@user> <@role>`", True),
            ...
            _help_cmd("clearnotes", "Delete all notes for a member.", "`/clearnotes <@user>`", True),
            _help_cmd("modlogs", "View mod log history for a user.", "`/modlogs <@user>`", True),
            _help_cmd("moderations", "View active timed moderations.", "`/moderations`", True),
            _help_cmd("case", "Show a single mod log case.", "`/case <number>`", True),
            _help_cmd("reason", "Update the reason for a mod case.", "`/reason <number> <text>`", True),
            _help_cmd("duration", "Change duration of a mute/ban.", "`/duration <number> <new_duration>`", True),
            _help_cmd("modstats", "Get moderation statistics for a mod.", "`/modstats [@mod]`", True),
            _help_cmd("lockdown", "Lock/unlock channels defined in settings.", "`/lockdown <start|end>`", True),
            _help_cmd("star", "View starboard stats for a message.", "`/star <message_id>`", True),
            _help_cmd("ignored", "List ignored users, roles, and channels.", "`/ignored`", True),
            _help_cmd("diagnose", "Diagnose bot permissions and module status.", "`/diagnose [target]`", True),
            _help_cmd("snipe", "View the most recently deleted message.", "`/snipe`", True),
            _help_cmd("editsnipe", "View the most recently edited message.", "`/editsnipe`", True),
            _help_cmd("purge", "Bulk delete messages in a channel.", "`/purge <amount> [@user]`", True),
            _help_cmd("nuke", "Clone and reset a channel.", "`/nuke [reason]`", True),
            _help_cmd("lock", "Lock a channel.", "`/lock [#channel] [reason]`", True),
            _help_cmd("unlock", "Unlock a channel.", "`/unlock [#channel]`", True),
            _help_cmd("hide_channel", "Hide a channel from regular members.", "`/hide_channel [#channel]`", True),
            _help_cmd("show_channel", "Show a hidden channel.", "`/show_channel [#channel]`", True),
            _help_cmd("block_channel", "Block a member or role from a channel.", "`/block_channel <@user/role> [#channel]`", True),
            _help_cmd("unblock_channel", "Unblock a member or role from a channel.", "`/unblock_channel <@user/role> [#channel]`", True),
            _help_cmd("slowmode", "Set channel slowmode.", "`/slowmode <seconds> [#channel]`", True),
            _help_cmd("image_only", "Allow only images and videos in a channel.", "`/image_only [#channel]`", True),
            _help_cmd("announce", "Send an announcement embed.", "`/announce <content> [#channel] [@role]`", True),
            _help_cmd("move_message", "Move a message to another channel.", "`/move_message <link> <#target>`", True),
            _help_cmd("clear_reactions", "Clear reactions from a message.", "`/clear_reactions <link>`", True),
            _help_cmd("pin_message", "Pin a message by link.", "`/pin_message <link>`", True),
            _help_cmd("unpin_message", "Unpin a message by link.", "`/unpin_message <link>`", True),
        ],
    },
    {
        "key": "role",
