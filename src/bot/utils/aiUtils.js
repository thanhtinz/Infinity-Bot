...
const { saveMessage, getHistory } = require('../../database/aiHistory');

const LUNA_SYSTEM_PROMPT = config.AI_PROMPTS.LUNA_SYSTEM_PROMPT;
const LUNA_CASUAL_PROMPT = config.AI_PROMPTS.LUNA_CASUAL_PROMPT;
